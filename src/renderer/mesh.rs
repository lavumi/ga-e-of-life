...
pub trait InstanceTileRaw: bytemuck::Pod + bytemuck::Zeroable {}
impl InstanceTileRaw for InstanceSimpleTileRaw {}
impl InstanceTileRaw for InstanceColorTileRaw {}

#[repr(C)]
#[derive(Copy, Clone, bytemuck::Pod, bytemuck::Zeroable)]
pub struct InstanceSimpleTileRaw {
    pub(crate) uv: [f32; 4],
    pub(crate) model: [[f32; 4]; 4],
}

impl InstanceSimpleTileRaw {
    pub fn desc<'a>() -> wgpu::VertexBufferLayout<'a> {
        use std::mem;
        wgpu::VertexBufferLayout {
            array_stride: mem::size_of::<InstanceSimpleTileRaw>() as wgpu::BufferAddress,
